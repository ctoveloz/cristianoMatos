...
/* CODERBITS */
!function(e,t){"use strict";var r=function(e){e+="";for(var t=e.split("."),r=t[0],a=t.length>1?"."+t[1]:"",i=/(\d+)(\d{3})/;i.test(r);)r=r.replace(i,"$1,$2");return r+a},a=function(e){var t="";return t+='<div id="coderbits-summary">',t+='<div id="coderbits-avatar">',t+='<a href="'+e.link+'" target="_parent">',t+='<img alt="'+e.name+'" class="avatar" src="https://secure.gravatar.com/avatar/'+e.gravatar_hash+'?d=https%3A%2F%2Fcoderbits.com%2Fimages%2Fgravatar.png&r=PG&s=48">',t+="</a>",t+="</div>",t+='<div id="coderbits-overview">',t+="<h1>",t+='<a href="'+e.link+'" target="_parent" title="'+e.name+'">'+e.name+"</a>",t+="</h1>",t+="<p>",t+="<span>"+e.title+"</span>",t+="</p>",t+="</div>",t+="</div>"},i=function(e){var t,r="";r+='<div id="coderbits-skills">';var a=["Skills","Interests","Traits","Areas"];!function(){for(var i=0;i<a.length;i++){var n="top_"+a[i].toLowerCase();if(e[n].length>0)return r+="<h2>Top "+a[i]+"</h2>",t=e[n],!0}}(),r+="<p>";for(var i=0;i<t.length;i++)r+=t[i].name,i<t.length-1&&(r+=", ");return r+="</p>",r+="</div>"},n=function(e){for(var t=0,a=0;a<e.badges.length;a++)e.badges[a].earned&&t++;var i="";return i+='<div id="coderbits-stats">',i+='<ul id="coderbits-stats-list">',i+="<li>",i+="<p>",i+="<strong>"+r(t)+"</strong>",i+="<span> badges</span>",i+="</p>",i+="<p>",i+="<strong>"+r(e.follower_count)+"</strong>",i+="<span> followers</span>",i+="</p>",i+="</li>",i+='<li class="last">',i+="<p>",i+="<strong>"+r(e.views)+"</strong>",i+="<span> views</span>",i+="</p>",i+="<p>",i+="<strong>"+r(e.following_count)+"</strong>",i+="<span> friends</span>",i+="</p>",i+="</li>",i+="</ul>",i+="</div>"},s=function(e){var t="",r=0,a=0;t+='<div id="coderbits-awards">',t+='<p id="coderbits-badges">';for(var i=0;i<e.badges.length;i++){var n=e.badges[i];n.earned&&(a++,30>r&&1===n.level&&(t+='<img src="'+n.image_link+'" width="40" height="40" title="'+n.name+" - "+n.description+'" alt="'+n.level+" bit "+n.name+" - "+n.description+'">',r++))}return t+='<a href="'+e.link+'/badges">view all '+a+"</a>",t+="</p>",t+="</div>"},o=function(e){var r=t.getElementsByTagName("script")[0],a=t.createElement("script");a.src=e,r.parentNode.insertBefore(a,r)},d="coderbits",l=t.getElementById(d);if(l){e[d]=function(r){var o="";o+=a(r),o+=i(r),o+=n(r),o+=s(r),t.getElementById(d).innerHTML=o,delete e[d]};var c=l.getAttribute("data-coderbits-username"),v=c.replace(/[('"){};!@#%&*]/gi,"");o("https://coderbits.com/"+v+".json?callback="+d)}}(window,document);
